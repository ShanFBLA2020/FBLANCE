<!-- 
	...
	Function		: Main page to manage all the award details
...
<?php include "../content1.html" ?>
	  ...
	  <div class="wrapper">
              <div class="row">
                <div class="col-md-6">
			<h2>Manage Award Details</h2>
		</div>
                <div class="col-md-6">
                  <div class="page-header clearfix">
                    <a href="create.php" class="btn btn-success pull-right"><span data-feather="plus-circle"></span> New Awards</a>
                  </div>
		</div>
	  </div>
          <div class="wrapper">
